...
from models.utils.misc import seed_everything, merge_opts_to_config, modify_config_for_debug
from models.utils.io import load_yaml_config
from models.engine.logger import Logger
from models.engine.solver import Solver
from models.distributed.launch import launch
...
def main():
    ...
    launch(main_worker, args.ngpus_per_node, args.num_node, args.node_rank, args.dist_url, args.backend, args=(args,))
